...
class Player(pygame.sprite.Sprite):
    ...
    def handle_collisions(self,direction, level):
        ...
        #     self.helper_methods.handle_spritegroup_collision(level.obstacle_sprites,0)
        #     self.helper_methods.handle_spritegroup_collision(level.transport_sprites,1)
        #     pass
        # elif direction=="Vertical":
        #     self.helper_methods.handle_spritegroup_collision_Vertical(level.obstacle_sprites,0)
        #     self.helper_methods.handle_spritegroup_collision_Vertical(level.transport_sprites,1)
        #     pass
        pass
    ...
    class PlayerHelperMethods:
        ...
        def handle_horizontal_collision(self,sprite):
            ...
            self.player.rect.x+=movement*right
            pass
        ...
        def handle_vertical_collision(self,sprite):
            ...
            while left<=right:
                ...
                if(self.player.mask.overlap(sprite.mask,offset)):
                    ...
                    left=mid+1
            # return right
            self.player.rect.y+=movement*right
            pass
